...
% Vary s2,s3, s4 (number of hidden units)
...
theta3 = 0.12 + (-0.12 - (0.12)).*rand(s4, s3 + 1);
theta4 = 0.12 + (-0.12 - (0.12)).*rand(k, s4 + 1);
...
% NN Function with 3 hidden layers
[J, theta1, theta2, theta3, theta4] = nn_three_hidden_layers(theta1, theta2, theta3, theta4, train_data, train_labels, num_iterations, alpha);
        
% Call determine_output fn
predicted_class = determine_output_three_layers(theta1, theta2, theta3, theta4, valid_data);
